...
//Creating Functionality for saveButton
  saveButtonNameList.addEventListener('click', function() {
    ...
    var titlePrincipalBox = document.createElement("h3");
      titlePrincipalBox.id = "titlePrincipalBoxId";
    var titlePrincipalBoxText = document.createTextNode(titleElementNameTask);
      titlePrincipalBoxText.id = "titlePrincipalBoxTextId"
  //Creates Div for the results of the last Text Area
    var SecondPrincipalContainer = document.createElement("div");
      SecondPrincipalContainer.id = "SecondPrincipalContainerId"
    //Creating Childrens
      titlePrincipalBox.appendChild(titlePrincipalBoxText);
      principalTaskDiv.appendChild(titlePrincipalBox);
      principalTaskDiv.appendChild(SecondPrincipalContainer);
...
//Add task function button
  addButtonTask.addEventListener('click', function(){
    var textTaskvalue = document.getElementById("textTask").value;
      textTaskvalue.id = "textTaskvalueId"
    var taskCard = document.createElement("p");
      taskCard.id = "taskCardId";
    var taskCardText = document.createTextNode(textTaskvalue);
      taskCardText.id =  "taskCardTextId";
  // Add text to Paragraph
    taskCard.appendChild(taskCardText);
    SecondPrincipalContainer.appendChild(taskCard);
  //ErasingArea
